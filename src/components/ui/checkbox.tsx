  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        "dark:data-[state=checked]:bg-primary data-[state=checked]:border-primary-border focus-visible:border-ring",
        "focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40",
        "aria-invalid:border-destructive size-5 shrink-0 rounded-[4px] border transition-shadow outline-none",
